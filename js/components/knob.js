...
app.component('knob', {
	...
	controller: function($rootScope, $element, $filter, DEFAULTS){
		...
		$knobCtrl.$onChanges = function(changes){
			$knobCtrl.update(el, changes.data.currentValue, changes.data.previousValue);
		};

		$knobCtrl.update = function(el, data, prevData){
